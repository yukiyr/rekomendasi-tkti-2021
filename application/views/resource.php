...
<body>
  ...
  <main id="main">
    ...
    <section class="kuis">
      <div class="container">
        <form action="<?= site_url('planstartup/index') ?>" role="form" method="POST" id="formVote2">
          <?php foreach ($resource as $resource): ?>
              <div class="card my-4 mx-3">
                  <div class="card-body">
                      <tr>
                          <div class="form-check form-check-inline">
                              <input class="form-check-input" type="radio" name="id_it_resource[]" id="inlineRadio1" value="<?php echo $resource->id_it_resource; ?>">
                              <label class="form-check-label" for="inlineRadio1"><?php echo $resource->it_resource ?></label>
                          </div>
                          <br>
                      </tr>
                  </div>
          ...
          <?php endforeach; ?>
          <a href="<?php echo site_url('domain/index') ?>" class="btn-learn-more">Kirim</a>
        </form>
      </div>
    </section>
