...
<body>
  ...
  <main id="main">
    ...
    <section class="kuis">
      <div class="container">
        <form action="<?= site_url('planstartup/kebutuhan') ?>" role="form" method="POST" id="formVote">
          <?php foreach ($perusahaan as $perusahaan): ?>
              <div class="card my-4 mx-3">
                  <div class="card-body">
                      <tr>
                          <div class="form-check form-check-inline">
                              <input class="form-check-input" type="radio" name="radio" id="inlineRadio1" value="<?php echo $perusahaan->id_jenis_perusahaan; ?>">
                              <label class="form-check-label" for="inlineRadio1"><?php echo $perusahaan->nama_jenis_perusahaan ?></label>
                          </div>
                          <br>
                      </tr>
                  </div>
